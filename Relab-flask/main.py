...
app.config["MONGO_URI"] = "mongodb+srv://sloth:mSCW5mKaiJOuABCG@cluster0.nljzd.mongodb.net/ReLab?retryWrites=true&w=majority" #Importante qui va specificato il nome del DB
...
def books():
    return send_file('src/books.json')
